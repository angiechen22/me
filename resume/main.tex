...
\begin{document}
    ...
    \section{Experience} 
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Owned the roadmap and launched a unified update publishing toolset—including a \href{https://aka.ms/dpp}{guided UI}, CLI, and ADO pipeline extension—that enabled first-party product teams to publish, distribute, and monitor updates at Windows install-base scale without the need for custom API integrations. Adopted by 2 product teams for retail rollout and flighting, with 5 more expected by year-end.
