...
\begin{document}
    ...
    \section{Experience} 
        ...
        \begin{twocolentry}
            ...
            \textit{Product Manager II - Microsoft Update Service}
        \end{twocolentry}

        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item Owned roadmap and shipped an update publishing toolset — \href{https://aka.ms/dpp}{guided UI}, CLI, and ADO pipeline extension — that eliminated the need for custom API integrations and enabled teams to ship updates to hundreds of millions of devices; now in active use across 5 product teams.
                
                \item Overhauled onboarding for internal product teams publishing via Microsoft Update, designing a requirements-gathering flow to reconcile diverse partner needs with platform constraints, cutting onboarding time from 28 to 9.5 days and supporting the migration of 19 teams from a legacy update service to Microsoft Update by June 2027.
        ...
        \begin{twocolentry}
            ...
            \textit{Product Manager II - Windows Update Client}
        \end{twocolentry}
       ...
       % EDVISER.AI
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Led product and UX definition for Edviser Studio, a no-code tool enabling higher education institutions to scale personalized student advising through a safety-governed, institution-controlled AI platform.
